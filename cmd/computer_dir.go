...
var computerDirCmd = &cobra.Command{
	Use:   "dir",
	Short: "Upload/download directories on a computer",
}

var computerDirUploadCmd = &cobra.Command{
	Use:   "upload <computer-id-or-name> <local-dir> <remote-path>",
	Short: "Upload a directory (as tarball) to a computer",
...
var computerDirDownloadCmd = &cobra.Command{
	Use:   "download <computer-id-or-name> <remote-path> [local-dir]",
	Short: "Download a directory from a computer (as tarball)",
...
func init() {
	computerDirCmd.AddCommand(computerDirUploadCmd)
	computerDirCmd.AddCommand(computerDirDownloadCmd)
}
