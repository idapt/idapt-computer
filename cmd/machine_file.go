...
var machineFileListCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if err := client.Get(cmd.Context(), "/api/v1/machines/"+id+"/sftp", q, &resp); err != nil {
			return err
		}
...
var machineFileReadCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := client.Download(cmd.Context(), "/api/v1/machines/"+id+"/sftp/download?"+q.Encode())
		if err != nil {
			return err
		}
...
var machineFileWriteCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if err := client.Post(cmd.Context(), "/api/v1/machines/"+id+"/sftp", body, nil); err != nil {
			return err
		}
...
var machineFileGrepCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		var resp map[string]interface{}
		if err := client.Post(cmd.Context(), "/api/v1/machines/"+id+"/tmux", body, &resp); err != nil {
			return err
		}
...
var machineFileUploadCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		resp, err := client.Upload(cmd.Context(), "/api/v1/machines/"+id+"/sftp/upload", fi.Name(), file, fields)
		if err != nil {
			return err
		}
