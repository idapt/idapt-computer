...
var machineUserListCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if err := client.Get(cmd.Context(), "/api/v1/machines/"+id+"/users", nil, &resp); err != nil {
			return err
		}
...
var machineUserCreateCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if err := client.Post(cmd.Context(), "/api/v1/machines/"+id+"/users", body, &resp); err != nil {
			return err
		}
...
var machineUserDeleteCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if err := client.Delete(cmd.Context(), "/api/v1/machines/"+id+"/users/"+args[1]); err != nil {
			return err
		}
...
var machineUserEditCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		var resp api.V1ItemResponse
		if err := client.Patch(cmd.Context(), "/api/v1/machines/"+id+"/users/"+args[1], body, &resp); err != nil {
			return err
		}
