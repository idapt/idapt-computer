...
var hookListCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if err := client.Get(cmd.Context(), "/api/v1/hooks", q, &resp); err != nil {
			return err
		}
...
var hookGetCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if err := client.Get(cmd.Context(), "/api/v1/hooks/"+url.PathEscape(args[0]), nil, &resp); err != nil {
			return err
		}
		formatter := f.Formatter()
		return formatter.WriteItem(resp.Data, []output.Column{{Header: "ID", Field: "id"}, {Header: "NAME", Field: "name"}, {Header: "SCOPE", Field: "scope"}, {Header: "PRIORITY", Field: "priority"}, {Header: "ENABLED", Field: "enabled"}})
	},
}
...
strings matching the schemas in lib/hooks/validation/schemas.ts. Example:
  ...
  idapt hook create \
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		var resp api.V1ItemResponse
		if err := client.Post(cmd.Context(), "/api/v1/hooks", body, &resp); err != nil {
			return err
		}
		formatter := f.Formatter()
		return formatter.WriteItem(resp.Data, []output.Column{{Header: "ID", Field: "id"}, {Header: "NAME", Field: "name"}, {Header: "SCOPE", Field: "scope"}, {Header: "PRIORITY", Field: "priority"}, {Header: "ENABLED", Field: "enabled"}})
...
var hookUpdateCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		var resp api.V1ItemResponse
		if err := client.Patch(cmd.Context(), "/api/v1/hooks/"+url.PathEscape(args[0]), body, &resp); err != nil {
			return err
		}
		formatter := f.Formatter()
		return formatter.WriteItem(resp.Data, []output.Column{{Header: "ID", Field: "id"}, {Header: "NAME", Field: "name"}, {Header: "SCOPE", Field: "scope"}, {Header: "PRIORITY", Field: "priority"}, {Header: "ENABLED", Field: "enabled"}})
...
var hookToggleCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		var resp api.V1ItemResponse
		if err := client.Post(cmd.Context(), "/api/v1/hooks/"+url.PathEscape(args[0])+"/toggle", body, &resp); err != nil {
			return err
		}
		formatter := f.Formatter()
		return formatter.WriteItem(resp.Data, []output.Column{{Header: "HOOK_ID", Field: "hook_id"}, {Header: "AGENT_ID", Field: "agent_id"}, {Header: "ENABLED", Field: "enabled"}})
	},
}
...
var hookOverrideCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		var resp api.V1ItemResponse
		if err := client.Post(cmd.Context(), "/api/v1/hooks/"+url.PathEscape(args[0])+"/override", body, &resp); err != nil {
			return err
		}
		formatter := f.Formatter()
		return formatter.WriteItem(resp.Data, []output.Column{{Header: "HOOK_ID", Field: "hook_id"}, {Header: "AGENT_ID", Field: "agent_id"}, {Header: "ENABLED", Field: "enabled"}})
...
var hookDeleteCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if err := client.Delete(cmd.Context(), "/api/v1/hooks/"+url.PathEscape(args[0])); err != nil {
			return err
		}
