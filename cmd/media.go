...
var mediaGenerateCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		sp := f.NewSpinner("Generating image")
		sp.Start()
		err = client.Post(cmd.Context(), "/api/v1/images/generations", body, &resp)
		sp.Stop()
		if err != nil {
			return err
		}
...
var mediaTranscribeCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		sp := f.NewSpinner("Transcribing audio")
		sp.Start()
...
var mediaSpeakCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		var resp api.V1ItemResponse
		sp := f.NewSpinner("Synthesizing speech")
		sp.Start()
		err = client.Post(cmd.Context(), "/api/v1/audio/speech", body, &resp)
		sp.Stop()
		if err != nil {
			return err
		}
