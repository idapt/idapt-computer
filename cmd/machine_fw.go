...
var machineFwListCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if err := client.Get(cmd.Context(), "/api/v1/machines/"+id+"/firewall", nil, &resp); err != nil {
			return err
		}
...
var machineFwAddCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if err := client.Post(cmd.Context(), "/api/v1/machines/"+id+"/firewall", body, &resp); err != nil {
			return err
		}
...
var machineFwRemoveCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if err := client.Delete(cmd.Context(), "/api/v1/machines/"+id+"/firewall/"+args[1]); err != nil {
			return err
		}
