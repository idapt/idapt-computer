...
Examples:
  ...
  idapt instructions file          — instructions for the file resource
  idapt instructions file delete   — same body as 'instructions file', plus a footer noting it's resource-scoped

Equivalent flag form on any command:
  idapt file delete --instructions
  idapt machine terminate --instructions
`,
