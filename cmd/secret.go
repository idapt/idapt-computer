...
var secretListCmd = &cobra.Command{
	Use:   "list",
	Short: "List secrets in the current workspace",
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if err := client.Get(cmd.Context(), "/api/v1/workspaces/"+workspaceID+"/secrets", nil, &resp); err != nil {
			return err
		}
		return f.ListFormatter("No secrets found.").WriteList(resp.Data, []output.Column{
			{Header: "ID", Field: "id"},
...
var secretCreateCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if err := client.Post(cmd.Context(), "/api/v1/workspaces/"+workspaceID+"/secrets", body, &resp); err != nil {
			return err
		}
...
var secretGetCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		var resp api.V1ItemResponse
		if err := client.Get(cmd.Context(), "/api/v1/workspaces/"+workspaceID+"/secrets/"+args[0], nil, &resp); err != nil {
			return err
		}
		return f.Formatter().WriteItem(resp.Data, []output.Column{
			{Header: "ID", Field: "id"},
...
var secretEditCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if err := client.Patch(cmd.Context(), "/api/v1/workspaces/"+workspaceID+"/secrets/"+args[0], body, nil); err != nil {
			return err
		}
...
var secretDeleteCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if err := client.Delete(cmd.Context(), "/api/v1/workspaces/"+workspaceID+"/secrets/"+args[0]); err != nil {
			return err
		}
