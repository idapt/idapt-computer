...
func (s *Server) authenticateVisitor(w http.ResponseWriter, r *http.Request, host string) (actorID string, ok bool) {
	if claims := s.validVisitorToken(r, host); claims != nil {
...
func (s *Server) validVisitorToken(r *http.Request, host string) *tokenClaims {
	token := ""
