...
const (
	AuthModePrivate = "private" // only the machine owner
	AuthModeProject = "project" // any member of the machine's project
...
func validate(cfg *Config) error {
	...
	for i, p := range cfg.Ports {
		...
		switch p.AuthMode {
		case AuthModePrivate, AuthModeProject, AuthModeIdapt:
		default:
			return fmt.Errorf("port %d: authMode must be private, project, or idapt", p.Port)
		}
		if seen[p.Port] {
