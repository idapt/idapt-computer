...
const (
	...
	ErrPolicyDisabled     = "policy-disabled"
...
type DesktopDisplaysResult struct {
	Displays []DesktopDisplay `json:"displays"`
}
...
const (
	...
	DesktopActionWaitForStable  = "wait-for-stable"
	DesktopActionListDisplays   = "list-displays"
	DesktopActionClipboardGet   = "clipboard-get"
	DesktopActionClipboardSet   = "clipboard-set"
	DesktopActionWindowList     = "window-list"
	DesktopActionWindowFocus    = "window-focus"
)
