...
const (
	...
	FlagProviderEndpoints = "ff59"

	FlagLocalInference = "ff60"

	FlagTunnels = "ff61"

	FlagComputerApps = "ff63"

	FlagCloudComputers = "ff70"

	FlagComputerRemoteShell = "ff72"

	FlagComputerRemoteFiles = "ff73"

	FlagComputerAdminOps = "ff74"

	FlagComputerUse = "ff75"
...
var Defaults = map[string]bool{
	...
	FlagComputers:           false, // ff29 = Computers
	FlagProviderEndpoints:   false, // ff59 = Provider Endpoints
	FlagLocalInference:      false, // ff60 = Local Inference
	FlagTunnels:             false, // ff61 = Tunnels
	FlagComputerApps:        false, // ff63 = Computer Apps
	FlagCloudComputers:      false, // ff70 = Cloud Computers
	FlagComputerRemoteShell: false, // ff72 = Computer Remote Shell
	FlagComputerRemoteFiles: false, // ff73 = Computer Remote Files
	FlagComputerAdminOps:    false, // ff74 = Computer Admin Ops
	FlagComputerUse:         false, // ff75 = Computer Use
