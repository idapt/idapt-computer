...
| `computer` | list, create, get, edit, delete, archive, unarchive, start, stop, test, exec, tmux, file, dir, fw, port, user, env-var | Daemon-backed computer management (commands, files, users, env, firewall) |
...
| `serve` | | Per-computer daemon (cloud-computer systemd service) |
